...
Date Developed: 6/16/2020
Last Date Changed: 6/16/2020
Rev: 2
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Menu menu1 = new Menu(1, "Plain", 5);
        Menu menu2 = new Menu(2, "Meat", 8);
        Menu menu3 = new Menu(3, "Extra", 10);
        ...
        while (userAction != EXIT_CODE) {
            switch(userAction) {
                ...
                case MENU_CODE : Menu.listMenu(mList);
                    break;
                case ORDE_CODE : main.addOrders(cList, mList);
    ...
    public void addOrders(ArrayList<Customer> clist, ArrayList<Menu> mlist) {
